...
public class VectorStoreConfig {
    ...
    public EmbeddingModel embeddingModel() {
        ...
        System.out.println("====================  Ollama API initialized  ========================= : " + ollamaApi);
        int embeddingDimension = embeddingModel.dimensions();
        System.out.println("==================== Embedding dimension: " + embeddingDimension+" embedding name: "+embeddingModel);
...
/*
    ...
    public void initStore(){
        Integer single = jdbcClient.sql("select count(*) from vector_store")
